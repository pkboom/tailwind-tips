            ...
            <div class="flex justify-between items-center border-b border-grey-dark">
                <div class="flex items-center py-4">
                    ...
                    <div class="text-grey flex flex-col md:flex-row md:items-center font-semibold">
                        ...
                        <a href="#" class="text-white">elated-stonebreaker-7088ad8a</a>
                    </div>
                </div>
                <div class="w-12">
                    <img class="block rounded-full h-8 w-8 border-grey-dark border-2" src="/images/netlify/girl-small.png" alt="">
                </div>
            </div>
            <nav class="flex flex-wrap items-center text-grey-dark font-semibold text-sm pt-4">
                <a href="#" class="pb-4 mr-3 hover:text-white">Overview</a>
                <a href="#" class="pb-4 mr-3 hover:text-white">Deploys</a>
                <a href="#" class="pb-4 mr-3 hover:text-white">Functions</a>
                <a href="#" class="pb-4 mr-3 hover:text-white">Identity</a>
                <a href="#" class="pb-4 mr-3 hover:text-white">Forms</a>
                <a href="#" class="pb-4 mr-3 hover:text-white">Split Testing</a>
                <a href="#" class="pb-4 mr-3 hover:text-white">Settings</a>
            </nav>
        </div>
    </header>
    <div class="container mx-auto -mt-20 px-4 mb-4">
        <div class="max-w-md bg-white rounded-lg shadow flex justify-center py-6 mb-8">
            <div class="px-6 md:px-4 lg:mr-6">
                <p class="font-bold text-xl mb-2">Settings for elated-stonebreaker-7088ad8a</p>
                <a href="#" class="block text-sm mb-3 text-grey-dark">tailwindcss.com</a>
                <p class="mb-3 text-grey-dark text-sm">Deploys from GibHub. Owned by Adam Wathan</p>
                <p class="text-sm text-grey-dark">Last update on Jul 11 (2 days)</p>
            </div>
            <a href="#" class="relative hidden lg:block" style="width: 160px; height: 100px;">
                <div class="absolute pin bg-black-20 hover:opacity-0"></div>
                <img src="/images/netlify/tailwind.png" alt="" class="rounded block overflow-hidden" style="width: 160px; height: 100px;">
            </a>
        </div>

        <div class="flex flex-no-wrap -mx-6 flex-col md:flex-row">
            <div class="sticky pin-t w-64 flex-none px-6 h-full" >
                <div class="border border-grey-lighter bg-white rounded shadow">
                    <div class="border-b">
                        <a href="#" class="hover:bg-grey-lighter block text-sm text-grey-darker py-2 pl-2 border-l-2 border-red">General</a>
                    </div>
                    <div class="border-b">
                        <a href="#" class="hover:bg-grey-lighter block text-xs text-grey-dark py-2 pl-4">Site Details</a>
                    </div>
                    <div class="border-b">
                        <a href="#" class="hover:bg-grey-lighter block text-xs text-grey-dark py-2 pl-4">Site administration</a>
                    </div>
                    <div class="border-b">
                        <a href="#" class="hover:bg-grey-lighter block text-xs text-grey-dark py-2 pl-4">Danger zone</a>
                    </div>
                    <div class="border-b">
                        <a href="#" class="hover:bg-grey-lighter block text-sm text-grey-darker py-2 pl-2">Build & deply</a>
                    </div>
                    <div class="border-b">
                        <a href="#" class="hover:bg-grey-lighter block text-sm text-grey-darker py-2 pl-2">Domain management</a>
                    </div>
                    <div class="border-b">
                        <a href="#" class="hover:bg-grey-lighter block text-sm text-grey-darker py-2 pl-2">Functions</a>
                    </div>
                    <div class="border-b">
                        <a href="#" class="hover:bg-grey-lighter block text-sm text-grey-darker py-2 pl-2">Identity</a>
                    </div>
                    <div class="border-b">
                        <a href="#" class="hover:bg-grey-lighter block text-sm text-grey-darker py-2 pl-2">Forms</a>
                    </div>
                    <div class="">
                        <a href="#" class="hover:bg-grey-lighter block text-sm text-grey-darker py-2 pl-2">Access control</a>
                    </div>
                </div>
            </div>
            <div class="flex-1 px-6">
                <div class="mb-4">
                    <h1 class="font-semibold">Site details</h1>
                    <p class="text-grey-dark text-sm">General information about your site</p>
                </div>
                <div class="border-grey-lighter bg-white rounded shadow p-6 mb-4">
                    <h3 class="text-lg font-semibold mb-2 border-b pb-3">Site information</h3>
                    <div class="-mx-6">
                        <table class="w-full text-sm text-grey-dark mb-4">
                            <tr>
                                <td class="w-1/4 px-6 py-2">Site name:</td>
                                <td class="w-3/4">
                                    <a href="#" class="text-black font-semibold border-b hover:border-black">elated-stonebreaker-7088ad8a</a>
                                </td>
                            </tr>
                            <tr>
                                <td class="w-1/4 px-6 py-2 bg-grey-lightest">Owner:</td>
                                <td class="w-3/4 bg-grey-lightest">
                                    <a href="#" class="text-black font-semibold border-b hover:border-black">Adam watham</a>
                                </td>
                            </tr>
                            <tr>
                                <td class="w-1/4 px-6 py-2">Repository</td>
                                <td class="w-3/4">
                                    <a href="#" class="text-black font-semibold border-b hover:border-black">github.com/tailwindcss/docs</a>
                                </td>
                            </tr>
                            <tr>
                                <td class="w-1/4 px-6 py-2 bg-grey-lightest">API ID:</td>
                                <td class="w-3/4 text-black font-semibold bg-grey-lightest">
                                    238f9283r928hff-34-egrfrgj384t53
                                </td>
                            </tr>
                            <tr>
                                <td class="w-1/4 px-6 py-2">Created:</td>
                                <td class="w-3/4 text-black font-semibold">
                                    Mar 4 at 1:14AM
                                </td>
                            </tr>
                            <tr>
                                <td class="w-1/4 px-6 py-2 bg-grey-lightest">Last update:</td>
                                <td class="w-3/4 text-black font-semibold bg-grey-lightest">
                                    Jul 11 at 4:00PM
                                </td>
                            </tr>
                    ...
                    <div>
                        <button type="button" class="border shadow px-4 py-2 font-semibold text-grey-darkest rounded">Change site name</button>
                    </div>
                </div>
                <div class="border-grey-lighter bg-white rounded shadow p-6">
                    <h3 class="text-lg font-semibold mb-2 border-b pb-3">Site information</h3>
                    <div class="-mx-6">
                        <table class="w-full text-sm text-grey-dark mb-4">
                            <tr>
    ...
    <div class="bg-black">
        <div class="container mx-auto px-6 py-8">
            <div class="text-sm text-grey-dark mb-4">
                <a href="#" class="pb-4 mr-3 hover:text-white">Docs</a>
                <a href="#" class="pb-4 mr-3 hover:text-white">Pricing</a>
                <a href="#" class="pb-4 mr-3 hover:text-white">Support</a>
                <a href="#" class="pb-4 mr-3 hover:text-white">News</a>
                <a href="#" class="pb-4 mr-3 hover:text-white">Some</a>
            </div>
            <p class="text-sm text-grey-dark">&copy; 2018 Netlify</p>
        </div>
    </div>
</body>
