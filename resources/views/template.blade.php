...
<body class="font-sans text-black ">
        ...
        <div class="flex items-center justify-between px-8">
            ...
            <div>
                <div class="flex items-center">
                    <a href="#" class="text-lg leading-normal text-blue hover:text-blue-dark no-underline ml-8">link</a>
                    <a href="#" class="text-lg leading-normal text-blue hover:text-blue-dark no-underline ml-8">link</a>
                    <a href="#" class="text-lg leading-normal text-blue hover:text-blue-dark no-underline ml-8">link</a>
                </div>
            </div>
    ...
    <section class="bg-blue-lightest h-full py-8 h-screen">
        <div class="flex items-center justify-center text-center h-full">
            <div>
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center sm:pt-3 mb-3 sm:mb-6">
                    <a href="#" class="flex items-center text-xl leading-none text-blue hover:text-blue-dark no-underline mb-2 sm:mb-0 sm:mr-4">
                        <div class="mr-3">
        ...
        <div class="w-5/6 max-w-lg mx-auto mt-8 mb-8">
            <div class="flex flex-wrap -mx-6 -my-6">
                <div class="w-full sm:w-1/2 px-6 py-6">
                    ...
                    <a href="#" class="text-lg leading-normal text-blue hover:text-blue-dark no-underline">Link to something</a>
                </div>
                <div class="w-full sm:w-1/2 px-6 py-6">
                    <div class="mb-8">
    ...
    <section class="bg-grey-lightest py-8">
        <div class="w-5/6 max-w-2xl mx-auto mt-8 mb-8">
            <div class="flex flex-wrap -mx-6 -my-6">
                <div class="w-full sm:w-1/2 lg:w-1/4 px-6 py-6">
                    ...
                    <h3 class="text-3xl font-semibold tracking-tight leading-none mb-3">Thie is a small heading</h3>
    ...
    <section class="bg-white py-8">
        ...
        <div class="w-5/6 max-w-md mx-auto pt-8 mt-8 mb-8">
            <div class="flex flex-wrap -mx-6 -my-6">
                <div class="w-full sm:w-1/2 px-6 py-6">
                    <div class="text-xl font-semibold leading-tight mb-3">Can I use these templates for free?</div>
    ...
    <section class="bg-grey-lightest py-8">
        <div class="w-5/6 max-w-2xl mx-auto mt-8">
            <div class="flex flex-wrap -mx-6 -my-6">
                <div class="w-full lg:w-1/3 px-6 py-6">
                    <a href="#" class="no-underline">
                        <div class="bg-pink-dark rounded shadow-lg overflow-hidden p-8">
                            <h5 class="text-xl text-white mb-4">Small heading</h5>
                            <p class="text-lg text-white leading-tight">This card is links to a deeper screen with more info on some topic.</p>
                        </div>
                    </a>
                </div>
                <div class="w-full lg:w-1/3 px-6 py-6">
        ...
        <div class="flex flex-col-reverse md:flex-row md:items-center md:justify-between px-8">
            ...
            <div class="mb-4 md:mb-0">
                <div class="flex flex-col md:flex-row md:items-center">
                    <a href="#" class="text-xl md:text-base leading-normal text-grey-dark hover:text-black no-underline mb-4 md:mb-0 md:ml-8">Link</a>
                    <a href="#" class="text-xl md:text-base leading-normal text-grey-dark hover:text-black no-underline mb-4 md:mb-0 md:ml-8">Another link</a>
                    <a href="#" class="text-xl md:text-base leading-normal text-grey-dark hover:text-black no-underline mb-4 md:mb-0 md:ml-8">Link to something</a>
                </div>
            </div>
        </div>
    </footer>  
